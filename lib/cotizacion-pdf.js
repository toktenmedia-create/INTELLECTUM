...
function condicionesDe(cotizacion) {
  ...
  return [
    ...
    hayMensualidad
      ? "La implementación se paga 60% al inicio y 40% al terminar. El servicio mensual se factura por adelantado, con dos opciones de permanencia a elegir en el contrato: mes a mes (renovación automática) o seis meses."

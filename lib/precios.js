 ...
 *
 * Lista aprobada por Paul el 24 de agosto de 2026. Vigencia: 1 de octubre de
...
export const PRECIOS = {
  ...
  //
  // EN LISTA DE ESPERA desde el 29 de agosto de 2026: el proveedor de telefonía
  // (Dapta) se canceló y todavía no hay reemplazo. Los precios se conservan
  // para no perder la referencia, pero con disponible:false el cotizador NO
  // los suma ni los promete: registra el interés y lo dice de frente.
  modulo_voz: {

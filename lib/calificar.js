 ...
 *   - Solo corre si la vuelta ESCRIBIÓ ficha de verdad: la señal (leadTocado)
 *     la encienden las herramientas al persistir, así que un rebote ("hora
 *     ocupada", "falta contacto") no paga clasificación.
...
export async function calificarConversacion({
  ...
  try {
    ...
    const hilo = historial
      ...
      .join("\n")
      .slice(-12_000); // si hay que recortar, se pierde el arranque, no el cierre

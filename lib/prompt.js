...
${cotiza
  ...
  : `2. NUNCA des una cifra de precio, ni un rango, ni un "desde". No tienes
   tarifas cargadas y no puedes deducirlas. Si preguntan cuánto cuesta: "el
   precio depende de lo que necesites; déjame tus datos y el equipo te pasa la
   cotización". Un número inventado aquí es un compromiso que el negocio no
   contrajo.`}

...
import { entregarLead, enviarAviso } from "./leads.js";
...
export const HERRAMIENTAS = {
  ...
  escalar_a_humano: {
    ...
    async ejecutar(entrada, ctx) {
      ...
      return enviado.entregado
        ...
        : "No se pudo avisar automáticamente. Dale el correo info@intellectum.ec y el WhatsApp +593 98 401 4129 para que escriba directo.";
    },
  },
  ...
  resumen_de_leads: {
    ...
    definicion: {
      ...
      input_schema: {
        ...
        properties: {
          dias: {
            type: "integer",
            description: "Cuántos días hacia atrás mirar. 7 para la semana, 30 para el mes.",
            minimum: 1,
            maximum: 365,
          },
        },
    ...
    async ejecutar(entrada, ctx) {
      const desde = new Date(Date.now() - entrada.dias * 86400000).toISOString();

    ...
    async ejecutar(entrada, ctx) {
      ...
      if (traspasada) {
        return enviado.entregado
          ...
          : "La conversación queda en manos de una persona del equipo, que le responderá por este mismo chat. Dale también el correo info@intellectum.ec por si prefiere escribir directo. Tú ya no respondes más aquí.";
      }
      return enviado.entregado

    ...
    async ejecutar(entrada, ctx) {
      ...
      if (traspasada) {
        return enviado.entregado
          ...
          : `La conversación queda en manos de una persona del equipo, que le responderá por este mismo chat. Dale también el correo ${NEGOCIO.correo} por si prefiere escribir directo. Tú ya no respondes más aquí.`;
      }
      return enviado.entregado
        ? "El equipo ya fue avisado. Dile a la persona que alguien la contactará, sin prometer un plazo concreto."
        : `No se pudo avisar automáticamente. Dale el correo ${NEGOCIO.correo} y el teléfono ${NEGOCIO.whatsapp} para que llame y escriba directo.`;
    },
  },

...
export const PLANES = {
  ...
  plataforma: {
    ...
    herramientas: [
      "guardar_lead",
      // El cotizador da rangos al instante. Vive solo en este plan porque la
      // matriz de lib/precios.js es LA DE INTELLECTUM: cuando un cliente quiera
      // su propio cotizador, su matriz irá en su ficha, no en este archivo.
      "cotizar",
      "escalar_a_humano",
      "ver_disponibilidad",
      "agendar_cita",
